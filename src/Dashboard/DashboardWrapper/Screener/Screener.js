        ...
        filteredArr = filteredArr.filter(
            (row) => {
                ...
                if (this.state.search6 !== "" && this.state.searchT6 == 1) {
                    return (row.GrossMargin < parseFloat(this.state.search6));
                }
                if (this.state.search6 !== "" && this.state.searchT6 == 2) {
                    return (Math.abs(row.GrossMargin - parseFloat(this.state.search6)) < 0.99);
                }
            ...
            <Paper >
                ...
                <div className="FormDiv">
                    <div id="Col1"
                        ...
                        <div id="Row1" align="left" style={{marginBottom:"10px"}}>
                        ...
                        <div id="Row2" align="left" style={{marginBottom:"10px"}}>
                        ...
                        <div id="Row3" align="left" style={{marginBottom:"10px"}}>
                        ...
                        <div id="Row4" align="left" style={{marginBottom:"10px"}}>
                        ...
                        <div id="Row5" align="left" style={{marginBottom:"10px"}}>
                        ...
                        <div id="Row6" align="left" style={{marginBottom:"10px"}}>
                            <span style={{ width: "120px", color: "#000000", fontfamily: "Arial", fontsize: "13px" }}>Gross Margin </span>
                        ...
                        <div id="Row7" align="left" style={{marginBottom:"10px"}}>
                    ...
                    <div id="Col2"
                        style={{ float: "left", borderLeft: "3PX double", padding: "10px", width: "30%", height: "250px", textalign: "left" }}>
                        <div id="Row21" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row2" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row3" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row4" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row5" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row6" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row7" align="left" style={{marginTop:"10px"}}>
                    ...
                    <div id="Col3"
                        style={{ float: "left", padding: "10px", borderLeft: "3PX double", width: "30%", height: "250px", textalign: "left" }}>
                        <div id="Row2" align="left" style={{marginTop:"10px"}}>
                        ...
                        <div id="Row1" align="left" style={{marginTop:"10px"}}>
